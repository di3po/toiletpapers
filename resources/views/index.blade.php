...
<main class="px-4 mb-auto mt-5">
  ...
  <!-- <div id="carouselExampleIndicators" class="carousel slide mb-auto" data-bs-ride="carousel" style="">
    ...
    <div class="carousel-inner">
      ...
      <img src="/images/brown.jpg" class="d-block w-100 h-auto" alt="...">
      </div>
      <div class="carousel-item">
        <img src="/images/yellow.jpg" class="d-block w-100 h-auto" alt="...">
      </div>
      <div class="carousel-item">
        <img src="/images/lightblue.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
